...
<html lang="en">
    <head>
        ...
        <title>Réinitialisation du mot de passe - SB Admin</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="inputEmail">adressse e-mail</label>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="login.html">Retour à la connexion</a>
                                                <a class="btn btn-primary" href="login.html">Réinitialiser le mot de passe</a>
                                            </div>
                                        </form>
                                    </div>
